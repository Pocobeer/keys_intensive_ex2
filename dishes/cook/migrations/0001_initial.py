# Generated by Django 3.2.25 on 2024-07-05 07:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dish_ingredients', models.ManyToManyField(to='cook.Ingredients')),
                ('dish_povar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cook.povar')),
            ],
        ),
    ]
